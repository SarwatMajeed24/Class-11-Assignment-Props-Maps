         ...
         <div>
             <div className="bg-slate-600">
                {/* Header Section */}
                 ...
                 {/* Car Details Section */}  
               <div className="flex flex-col items-center justify-between bg-slate-200 px-4 md:px-4">
                  <h1  className="text-2xl md:text-4xl font-extrabold text-blue-500 mb-2 mt-16">Featured New Cars</h1>
       
        <div className="flex flex-wrap justify-center gap-6 bg-slate-200 min-h-screen my:16 md:my-32">{
            carDetails.map ((car, index) => {
                return (
                   <div 

                     key={index}
                    className="flex flex-col items-center border border-gray-300 rounded-lg p-4 shadow-md w-full sm:w-[300px] h-[350px] mb-24 mt- bg-green-600">
                    <ChildComponent
                        cName = {car.carName}
                        cPrice= {car.carPrice}
                        cImage= {car.carImage}
            ...
            <div className="bg-slate-400 w-full mt-8">
                  {/* Footer Section */}
